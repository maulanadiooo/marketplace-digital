		    ...
		    <div class="page-header">
				...
				<div class="card">
					<div class="card-body">
					    ...
					    ?>
						<h1 class="mb-0 text-uppercase">Email verifikasi</h1>
						<hr/>
					...
					<div class="card-body">
					    ...
					    ?>
    					<h1 class="mb-0 text-uppercase">Reset Password</h1>
    					<hr/>
					...
					<div class="card-body">
					    ...
					    ?>
    					<h1 class="mb-0 text-uppercase">Orderan Masuk</h1>
    					<hr/>
					...
					<div class="card-body">
					    ...
					    ?>
    					<h1 class="mb-0 text-uppercase">Pembaruan Orderan</h1>
    					<hr/>
					...
					<div class="card-body">
					    ...
					    ?>
    					<h1 class="mb-0 text-uppercase">Pesan Masuk</h1>
    					<hr/>
					...
					<div class="card-body">
					    ...
					    ?>
    					<h1 class="mb-0 text-uppercase">Deposit Berhasil</h1>
    					<hr/>
					...
					<div class="card-body">
					    ...
					    ?>
    					<h1 class="mb-0 text-uppercase">Invoice Sukses</h1>
    					<hr/>
