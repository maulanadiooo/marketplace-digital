...
class Model {
	...
	public function db_query_cat($db, $select, $table, $where = null, $order = 'name ASC', $limit = '') {
		$query = mysqli_query($db, "SELECT ".$select." FROM ".$table." ORDER BY ".$order." ".$limit);
		if ($where <> null) {
			$query = mysqli_query($db, "SELECT ".$select." FROM ".$table." WHERE ".$where." ORDER BY ".$order." ".$limit);
		}
	...
	public function db_query_limit($db, $select, $table, $where = null, $order = 'updated_at DESC', $limit = '1') {
		$query = mysqli_query($db, "SELECT ".$select." FROM ".$table." ORDER BY ".$order." ".$limit);
		if ($where <> null) {
			$query = mysqli_query($db, "SELECT ".$select." FROM ".$table." WHERE ".$where." ORDER BY ".$order." ".$limit);
		}
