...
if(!isset($_GET['query_tagss'])){
    exit(header("Location: ".$config['web']['base_url']));
} else {
$keyword = $db->real_escape_string(trim(htmlspecialchars(htmlentities($_GET['query_tagss']))));
$data_target = mysqli_query($db, "SELECT * FROM services WHERE tags LIKE '%$keyword%' AND status = 'active' ORDER BY created_at DESC");
